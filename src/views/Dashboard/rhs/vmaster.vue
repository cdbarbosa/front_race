<template id="">
  <main id="master">
    ...
    <div class="content __display">
      <rh-table v-if="rhs" :resources="rhs" :filterActive="filterActive" :setFunction="setRhFilters" :document="true" :selectedIndex="selectedIndex" @update="setRhSelected($event[0])" @filter="filter($event)" @searchByDocument="searchUserByDocument" @restore="restoreRhs($event)">
