<template>
  <main id="master">
    ...
    <service-table v-if="services" :options="serviceTableOptions" :filterActive="filterActive" :selectedIndex="selectedIndex" :resources="services" @search="filterServices($event)" @restore="restoreServices" @update="setServiceSelected($event)" @filter="isFilterModal = true">
